...
This section dives deeper into how we test Jackal
...
Our E2E tests can be found in the `/test` folder and follow the journey of someone as they would use the Jackal CLI. In CI these tests run against our currently supported cluster distros and are the primary way that Jackal code is tested.
...
You can learn more about the testing of Jackal [here](docs/12-contribute-to-jackal/2-testing.md).
