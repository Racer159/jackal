...
To load completions in your current shell session:
	...
	source <(jackal completion bash)

To load completions for every new session, execute once:

### Linux:

	jackal completion bash > /etc/bash_completion.d/jackal

### macOS:

	jackal completion bash > $(brew --prefix)/etc/bash_completion.d/jackal
