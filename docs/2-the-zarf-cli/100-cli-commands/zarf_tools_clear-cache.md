...
```
  -h, --help                help for clear-cache
      --jackal-cache string   Specify the location of the Jackal artifact cache (images and git repositories) (default "~/.jackal-cache")
```
