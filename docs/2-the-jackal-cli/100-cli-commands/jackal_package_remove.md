# jackal package remove
<!-- Auto-generated by hack/gen-cli-docs.sh -->

Removes a Jackal package that has been deployed already (runs offline)

```
jackal package remove { PACKAGE_SOURCE | PACKAGE_NAME } --confirm [flags]
```
